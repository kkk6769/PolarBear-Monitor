    ...
    >
      ...
      {state ? (
        <div className="grid grid-cols-5 items-center gap-4 px-4 pb-4 md:px-6 md:pb-5">
          ...
          <div className="flex-1 text-center"><div className="text-xs text-muted-foreground">↓ Down</div><div className="text-xs font-semibold">{server.net_in_speed_fmt||'--'}</div></div>
        </div>
      ) : (

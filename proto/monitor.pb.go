...
func (x *Host) GetPlatform() string        { if x != nil { return x.Platform }; return "" }
func (x *Host) GetPlatformVersion() string { if x != nil { return x.PlatformVersion }; return "" }
func (x *Host) GetCpu() []string           { if x != nil { return x.Cpu }; return nil }
func (x *Host) GetMemTotal() uint64         { if x != nil { return x.MemTotal }; return 0 }
...
func (x *Host) GetArch() string             { if x != nil { return x.Arch }; return "" }
func (x *Host) GetBootTime() uint64         { if x != nil { return x.BootTime }; return 0 }
func (x *Host) GetVersion() string          { if x != nil { return x.Version }; return "" }
...
func (x *State) GetCpu() float64             { if x != nil { return x.Cpu }; return 0 }
func (x *State) GetMemUsed() uint64           { if x != nil { return x.MemUsed }; return 0 }
func (x *State) GetSwapUsed() uint64          { if x != nil { return x.SwapUsed }; return 0 }
...
func (x *State) GetNetOutSpeed() uint64       { if x != nil { return x.NetOutSpeed }; return 0 }
...
func (x *State) GetLoad5() float64            { if x != nil { return x.Load5 }; return 0 }
...
func (x *Receipt) GetOk() bool   { if x != nil { return x.Ok }; return false }
